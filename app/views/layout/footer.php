...
<footer class=" footer text-center text-lg-start text-white p-0">
    <div class="container-fluid py-2 pb-0">
      <section>
        <div class="row">
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto">
            <h5 class=" mb-4 font-weight-bold ">EvolBooks </h5>
            <p>
              <strong> EvolBooks </strong>is your go-to destination for discovering the latest and greatest in books.
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-0 px-2 ">
            ...
            <p><a href="/evol/public/books" style="text-decoration: none;">Books</a></p>
            <p><a href="/evol/public/contact" style="text-decoration: none;">contact</a></p>
            <p><a href="/evol/public/about" style="text-decoration: none;">About</a></p>
          </div>
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-lg-8 text-center text-md-start">
            <div class="license p-3  ">
              ...
              <a href="/evol/public/admin" class="no-underline" style="text-decoration: none;">EvolBooks</a>
            </div>
          </div>
...
<a href="/evol/public/auth/login" class="btn btn-dark px-4 me-2">
Login
</a>
